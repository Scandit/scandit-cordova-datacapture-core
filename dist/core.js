...
class ImageFrameSourceController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.FrameSourceListenerEvents.didChangeState, (data) => {
...
class DataCaptureContextController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.DataCaptureContextEvents.didChangeStatus, (data) => {
            const event = EventDataParser.parse(data);
            if (event === null) {
...
class DataCaptureViewController extends BaseController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.DataCaptureViewEvents.didChangeSize, (data) => {
            const event = EventDataParser.parse(data);
            if (event === null) {
...
exports.AdvancedNativeProxy = AdvancedNativeProxy;
...
exports.BaseNewController = BaseNewController;
exports.Brush = Brush;
...
exports.EventDataParser = EventDataParser;
...
exports.createAdvancedNativeProxy = createAdvancedNativeProxy;
